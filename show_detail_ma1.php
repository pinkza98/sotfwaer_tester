   ...
   <button type="summit"  class="btn btn-success btn-xs">เพิ่ม</button>
    ...
    $query = "SELECT * FROM case_main WHERE system_test='ระบบงานทรัพย์สิน' AND rights_case='ผู้ใช้งานทั่วไป'ORDER BY id_case asc limit {$start} , {$perpage}";
    ...
    ?>
     ...
     <?php
      $query1 = "SELECT * FROM case_main WHERE system_test='ระบบงานทรัพย์สิน' AND rights_case='ผู้ใช้งานทั่วไป'";
        ...
        <div class="col-md-12 text-center">
          <div class="site-block-27">
            <nav>
              ...
              <?php }else{?>
              <li><a href="show_detail_ma1.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
              <?php }?>
