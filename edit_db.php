...
if (!empty( $_FILES["img_case"]["name"])) 
{
    mysqli_query($mysqli, "UPDATE case_main SET img_case='".$_FILES['img_case']['name']."' WHERE id_case='$id_case'");
    move_uploaded_file($_FILES['img_case']['tmp_name'],"images_test/".$_FILES['img_case']['name']);
}
...
$sql = "UPDATE case_main SET 
        genre_case='$genre_case',
