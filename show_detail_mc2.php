...
<div class="bg-light py-3">
          <div class="container">
            <div class="row">
              <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span> <a href="show_case.php">All Case</a> <span class="mx-2 mb-0">/</span><a href="show_genre_mc.php">ระบบงานบริการยานพาหนะ</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">เจ้าหน้าที่</strong></div>
            </div>
          </div>
        </div>
        <div class="container">
   ...
   <button type="summit"  class="btn btn-success btn-xs" style="width:80px;height:40px">เพิ่ม</button>
    ...
    <?php include 'detail_input.php'; ?>
      ...
      <?php
    $query = "SELECT * FROM case_main WHERE system_test='ระบบงานบริการยานพาหนะ' AND rights_case='เจ้าหน้าที่'ORDER BY id_case asc limit {$start} , {$perpage}";
  ...
  <?php
    $query1 = "SELECT * FROM case_main WHERE system_test='ระบบงานบริการยานพาหนะ' AND rights_case='เจ้าหน้าที่'";
    ...
    <div class="col-md-12 text-center">
      <div class="site-block-27">
        <nav>
          ...
          <?php }else{?>
          <li><a href="show_detail_mc2.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
          <?php }?>
        <?php } ?>
            </ul>
        </nav>
